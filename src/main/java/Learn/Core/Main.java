...
public class Main {
    ...
    public void main(String[] args) throws InterruptedException {
        ...
        StartupJobs StartupJobsStaticOverride = new StartupJobs();
        StartupJobsStaticOverride.main(args);
...
// Log debug information if debug mode is enabled
        if (DebugMode.isDebug()) {
            Logger.debug("Learn.Core.Main", "Running version " + PublicVariables.VersionNum);
            ...
            Logger.debug("Learn.Core.Main", "Running on " + PublicVariables.osType +"on a " + PublicVariables.deviceArch + " device");
